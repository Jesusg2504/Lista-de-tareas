...
const botonEnter = document.querySelector('#botondeinicio')
...
let id 
function agregarLista( tarea,id,realizado,eliminado) {
...
botonEnter.addEventListener('click', ()=> {
    ...
    if(tarea){
        agregarLista(tarea,id,false,false)
        LIST.push({
            nombre : tarea,
            id : id,
            realizado : false,
...
function cargarLista(array) {
    array.forEach(function(item){
        agregarLista(item.nombre,item.id,item.realizado,item.eliminado)
    })
}